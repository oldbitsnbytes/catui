...
struct component
{
    static std::map<lang::type::value, const char*> type_enums;
    ...
    static ui::color::value  fg_color_attr(mnemonic m);
    static ui::color::value  bg_color_attr(mnemonic m);
};


} // end-namespace cat::lang
