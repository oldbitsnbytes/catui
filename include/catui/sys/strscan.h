...
public:
    ...
    cat::string::location<std::string_view> location{};
    ...
    cat::string::location<std::string_view>& sync();
    ...
    [[nodiscard]] cat::string mark() const;
...
#include <catui/sys/strscan.numeric_data.value.inc.h>
